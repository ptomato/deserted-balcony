...
const X11_COLORS = ['alice blue', 'antique white', 'aquamarine', 'azure',
    ...
    'cornflower', 'cornsilk', 'crimson', 'cyan', 'dark blue', 'dark cyan',
    ...
    'green yellow', 'honeydew', 'hot pink', 'indian red', 'indigo', 'ivory',
    'khaki', 'lavender', 'lavender blush', 'lawn green', 'lemon chiffon',
    'light blue', 'light coral', 'light cyan', 'light goldenrod', 'light gray',
    'light green', 'light pink', 'light salmon', 'light sea green',
    'light sky blue', 'light slate gray', 'light steel blue', 'light yellow',
    'lime green', 'linen', 'magenta', 'maroon', 'web maroon',
    ...
    'misty rose', 'moccasin', 'navajo white', 'navy blue', 'old lace', 'olive',
    'olive drab', 'orange', 'orange red', 'orchid', 'pale goldenrod',
    'pale green', 'pale turquoise', 'pale violet red', 'papaya whip',
    'peach puff', 'peru', 'pink', 'plum', 'powder blue', 'purple', 'web purple',
    'rebecca purple', 'red', 'rosy brown', 'royal blue', 'saddle brown',
